...
SELECT (select consinco.pkg_financeiro.ffip_buscaseq() from dual) "SeqIntTitulo", 1 "TipoRegistro", 
1  "NroEmpresaMae",
...
/*(select consinco.pkg_financeiro.ffip_buscaseq() from dual)*/ 1 "SeqTitulo",
2  "SeqDepositario",
/*(select consinco.pkg_financeiro.ffip_buscaseq() from dual)*/ 1 "NroProcesso",
...
null "IndGerouReplicacao", null "SeqCtacorrente", '14-09-2021' "DtaOperacao",
'14-09-2021', null "DtaContabilizacao"
...
DELETE FROM consinco.fi_inttitulo f WHERE f.seqinttitulo = 633;
