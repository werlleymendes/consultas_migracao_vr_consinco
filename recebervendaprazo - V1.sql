...
'DUPR' as "CodEspecie", null as "TipoCodGerente", 
null as "CodGerente",null as "TipoCodVendedor", 
...
LEFT JOIN (SELECT rv.id as id, sum(rvi.valor) as valor FROM recebervendaprazo rv, 
		   recebervendaprazoitem rvi 
