...
SELECT CONSINCO.S_FINANCEIRO.NEXTVAL "SeqIntTitulo", 1 "TipoRegistro", 
1  "NroEmpresaMae",
...
null "IndGerouReplicacao", null "SeqCtacorrente", '10-09-2021' "DtaOperacao",
'10-09-2021', null "DtaContabilizacao"
...
DELETE FROM consinco.fi_inttitulo f WHERE f.seqinttitulo = 631; 
